...
<body>
    ...
    <div id="modal1" class="modal">
        <form action="../../../../Controller/ControllerImagenProyecto.php" id="add-form" method="POST" enctype="multipart/form-data">
      ...
      <div id="modal2" class="modal">
        <form action="../../../../Controller/ControllerImagenProyecto.php" id="edit-form" method="POST" enctype="multipart/form-data">
        <div class="modal-content">
        <input type="hidden" name="idUser" value="<?=$_SESSION['idUsuario'];?>"></input>
...
<div class="row">
  ...
  <ul id="slide-out" class="side-nav fixed">
    <li class="titulo">Tablas</li>
      ...
      <li class="selected"><a href="../ImagenProyecto/imagenproyecto.php"">Imagen Proyecto</a></li>
