          ...
          <form id="add-form" action="" method="POST" class="col s12">
             ...
             <div class="row">
              <div class="input-field col s12"><i class="material-icons prefix">account_circle</i>
                <input id="icon_prefix" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="Fecha" class="validate" required>
      ...
      <div class="modal-content">
        <div class="row">
          <form id="edit-form" action="" method="" class="col s12">
             ...
             <div class="row">
              <div class="input-field col s12"><i class="material-icons prefix">account_circle</i>
                <input id="icon_prefix" type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="NuevoFecha" class="validate" required>
                <label for="icon_prefix">Fecha</label>
              </div>
            </div>
            <div class="modal-footer">
